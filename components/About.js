...
export default function About({pageInfo}) {
  return (
    <motion.div
      ...
      <Image className='-mb-20 md:mb-3 flex-shrink w-48 h-48 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[300px] xl:h-[300px]'
        src='/../public/yash.jpg'
      ...
      <div className="space-y-6 px-0 md:px-10 mt-6">
        <h4 className="text-4xl font-semibold">Here is a little background
        </h4>
